...
export default function AttendanceReport() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-5xl">
      <h1 className="text-2xl font-bold mb-6">Attendance Attendance</h1>
      ...
      <div className="grid gap-6 md:grid-cols-3 mb-8">
        ...
        <div className="space-y-2">
          ...
          <Select>
            ...
            <SelectContent>
              <SelectItem value="odysseus">Odysseus Morin</SelectItem>
            </SelectContent>
          </Select>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="px-4 py-2 text-left">Attendance Date</th>
              ...
              <tbody>
                {filteredMembers.map((member) => (
                  <tr key={member.id} className="border-b">
                    ...
                    <td className="px-4 py-2">{member.group_name}</td>
                    <td className="px-4 py-2">{member.attendanceDate}</td>
